// game-galaxy.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component. Import and use:
//   <script type="module" src="./game-galaxy.js"></script>
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    // ── Layer 2: core ──
    {
        var p = vec2f(uv.x * aspect, uv.y);
        // stage 0: circle(...)
        var sdf_result = sdf_circle(p, 0.1);
...
class GameGalaxy extends HTMLElement {
...
customElements.define('game-galaxy', GameGalaxy);
export { GameGalaxy };
export default GameGalaxy;
