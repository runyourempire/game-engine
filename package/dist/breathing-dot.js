// breathing-dot.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./breathing-dot.js"></script>
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    // stage 0: circle(...)
    var sdf_result = sdf_circle(p, (0.15 + (sin((time * 2.0)) * 0.03)));
...
void fs_main(input: VertexOutput){
    ...
    // stage 0: circle(...)
    float sdf_result = sdf_circle(p, (0.15 + (sin((time * 2.0)) * 0.03)));
...
class BreathingDot extends HTMLElement {
...
customElements.define('breathing-dot', BreathingDot);
export { BreathingDot };
