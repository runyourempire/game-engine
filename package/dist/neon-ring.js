// neon-ring.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component. Import and use:
//   <script type="module" src="./neon-ring.js"></script>
//   <neon-ring></neon-ring>
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    color_result = vec4f(color_result.rgb + max(pp_lum - 0.5, 0.0) * 1.5, 1.0);

    // stage 4: vignette(...)
    color_result = vec4f(color_result.rgb * (1.0 - length(uv) * 0.3), 1.0);

    return color_result;
}
`;

class NeonRing extends HTMLElement {
...
customElements.define('neon-ring', NeonRing);
export { NeonRing };
