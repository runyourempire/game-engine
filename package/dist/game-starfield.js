// game-starfield.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component. Import and use:
//   <script type="module" src="./game-starfield.js"></script>
//   <game-starfield></game-starfield>
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    // stage 1: star(...)
    var sdf_result = sdf_star(p, 5.0, 0.12, 0.05);
...
class GameStarfield extends HTMLElement {
...
customElements.define('game-starfield', GameStarfield);
export { GameStarfield };
export default GameStarfield;
