// metric-ring.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./metric-ring.js"></script>
...
void fs_main(input: VertexOutput){
    ...
    // stage 0: ring(...)
    float sdf_result = abs(length(p) - 0.35) - 0.06;
...
class MetricRing extends HTMLElement {
...
customElements.define('metric-ring', MetricRing);
export { MetricRing };
