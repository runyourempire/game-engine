// audio-hello.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./audio-hello.js"></script>
//   <audio-hello></audio-hello>
...
void fs_main(input: VertexOutput){
    ...
    fragColor = vec4(vec3(glow_result), 1.0);
}
`;

class AudioHello extends HTMLElement {
  ...
  _frame() {
    ...
    // Update param values
    this._paramValues[0] = (this._arcBaseOverrides?.[0] ?? 0.3) + (audioBass * 0.5);
    this._paramValues[1] = (this._arcBaseOverrides?.[1] ?? 2) + (audioEnergy * 12.0);
...
customElements.define('audio-hello', AudioHello);
export { AudioHello };
export default AudioHello;
