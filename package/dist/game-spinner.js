// game-spinner.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./game-spinner.js"></script>
//   <game-spinner></game-spinner>
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    // stage 0: rotate(...)
    { let rc = cos((time * 3.0)); let rs = sin((time * 3.0));
    ...
    sdf_result = select(999.0, sdf_result, arc_theta < 4.0);
...
void fs_main(input: VertexOutput){
    ...
    // stage 1: ring(...)
    float sdf_result = abs(length(p) - 0.25) - 0.03;

    // stage 2: mask_arc(...)
    float arc_theta = atan2(p.x, p.y) + 3.14159265359;
    sdf_result = (arc_theta < 4.0 ? sdf_result : 999.0);

    // stage 3: glow(...)
    float glow_result = apply_glow(sdf_result, 2.5);
...
class GameSpinner extends HTMLElement {
...
customElements.define('game-spinner', GameSpinner);
export { GameSpinner };
