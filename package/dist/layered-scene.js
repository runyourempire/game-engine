// layered-scene.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./layered-scene.js"></script>
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    let glow_i = u.p_glow_i;
    let orb_glow = u.p_orb_glow;
    ...
    // ── Layer 0: bg ──
    {
        ...
        // stage 0: gradient(...)
        var color_result = vec4f(mix(vec3f(0.0, 0.02, 0.15), vec3f(0.0, 0.0, 0.1), length(uv)), 1.0);
    ...
    // ── Layer 1: ring ──
    {
        ...
        // stage 1: glow(...)
        let glow_result = apply_glow(sdf_result, glow_i);
    ...
    // ── Layer 2: orb ──
    {
        ...
        // stage 1: glow(...)
        let glow_result = apply_glow(sdf_result, orb_glow);
...
uniform float u_p_glow_i;
uniform float u_p_orb_glow;
...
void fs_main(input: VertexOutput){
    ...
    float glow_i = u_p_glow_i;
    float orb_glow = u_p_orb_glow;
    ...
    // ── Layer 0: bg ──
    {
        ...
        // stage 0: gradient(...)
        vec4 color_result = vec4(mix(vec3(0.0, 0.02, 0.15), vec3(0.0, 0.0, 0.1), length(uv)), 1.0);
    ...
    // ── Layer 1: ring ──
    {
        ...
        // stage 1: glow(...)
        float glow_result = apply_glow(sdf_result, glow_i);
    ...
    // ── Layer 2: orb ──
    {
        ...
        // stage 1: glow(...)
        float glow_result = apply_glow(sdf_result, orb_glow);
...
class LayeredScene extends HTMLElement {
  ...
  bounce: t => { const n=7.5625, d=2.75; if(t<1/d) return n*t*t; if(t<2/d) return n*(t-=1.5/d)*t+0.75; if(t<2.5/d) return n*(t-=2.25/d)*t+0.9375; return n*(t-=2.625/d)*t+0.984375; },
      ...
      this._arcEase = ease;
      this._arcTimeline = [
        { t: 0, name: 'dim', transitions: [{ pi: 0, to: 0.5, anim: false, ease: 'linear', dur: 2 },{ pi: 1, to: 1, anim: false, ease: 'linear', dur: 2 },] },
        { t: 2, name: 'ignite', transitions: [{ pi: 0, to: 3, anim: true, ease: 'expo_out', dur: 2 },{ pi: 1, to: 6, anim: true, ease: 'expo_out', dur: 3 },] },
        { t: 8, name: 'breathe', transitions: [{ pi: 0, to: 1.5, anim: true, ease: 'cubic_in_out', dur: 4 },{ pi: 1, to: 3, anim: true, ease: 'smooth', dur: 3 },] },
      ];
    ...
    // Update param values
    this._paramValues[0] = (this._arcBaseOverrides?.[0] ?? 2) + 0;
    this._paramValues[1] = (this._arcBaseOverrides?.[1] ?? 4) + 0;
  ...
  _initWebGL2() {
    ...
    this._glParamUniforms[0] = gl.getUniformLocation(prog, 'u_p_glow_i');
    this._glParamUniforms[1] = gl.getUniformLocation(prog, 'u_p_orb_glow');
