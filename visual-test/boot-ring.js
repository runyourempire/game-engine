...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 1: texture ──
    {
        ...
        var color_result = vec4<f32>(cosine_palette(sdf_result, vec3<f32>(0.050000, 0.030000, 0.010000), vec3<f32>(0.300000, 0.180000, 0.060000), vec3<f32>(1.000000, 0.700000, 0.400000), vec3<f32>(0.000000, 0.100000, 0.200000)), 1.0);
...
void main(){
    ...
    // ── Layer 1: texture ──
    {
        ...
        vec4 color_result = vec4(cosine_palette(sdf_result, vec3(0.050000, 0.030000, 0.010000), vec3(0.300000, 0.180000, 0.060000), vec3(1.000000, 0.700000, 0.400000), vec3(0.000000, 0.100000, 0.200000)), 1.0);
